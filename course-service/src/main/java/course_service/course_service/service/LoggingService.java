...
public class LoggingService {
    ...
    public void logUnitActivity(int statusCode, String action, String metadata) {
        logger.info("Unit-service | Status: {} | Action: {} | Metadata: {}", statusCode, action, metadata);
    }

    public void logLessonActivity(int statusCode, String action, String metadata) {
        logger.info("Lesson-service | Status: {} | Action: {} | Metadata: {}", statusCode, action, metadata);
    }

...
public class LoggingService {
    ...
    public void logEnrollActivity(int statusCode, String action, String metadata) {
        logger.info("Enroll-service | Status: {} | Action: {} | Metadata: {}", statusCode, action, metadata);
    }
    ...
    public void logError(Exception e, String action) {
        ...
        logger.error("Enroll-service | Status: {} | Action: {} | Error: {}", statusCode, action, e.getMessage());
    }
